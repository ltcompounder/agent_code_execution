...
def APO(params: dict = None) -> dict:
    ...
    Args:
        params (dict, optional): Dictionary containing the following parameters:
            ...
            matype (optional, integer): Moving average type. By default, matype=0. Integers 0 - 8 are accepted with the following mappings.
    ...
    if params is None:
        params = {}
    return call_mcp_tool("APO", params)
