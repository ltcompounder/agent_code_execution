...
def PLUS_DM(params: dict = None) -> dict:
    """
    ...
    Args:
        params (dict, optional): Dictionary containing the following parameters:
            ...
            time_period (required, integer): Number of data points used to calculate each PLUS_DM value. Positive integers are accepted.
    ...
    if params is None:
        params = {}
    return call_mcp_tool("PLUS_DM", params)
