...
def DIGITAL_CURRENCY_DAILY(params: dict = None) -> dict:
    """
    ...
    Args:
        params (dict, optional): Dictionary containing the following parameters:
            ...
            datatype (optional, string): By default, datatype=csv. Strings json and csv are accepted with the following specifications: json returns the daily time series in JSON format; csv returns the data as a CSV (comma separated value) file.
    ...
    if params is None:
        params = {}
    return call_mcp_tool("DIGITAL_CURRENCY_DAILY", params)
...
if __name__ == "__main__":
    ...
    print("Testing DIGITAL_CURRENCY_DAILY...")
    result = DIGITAL_CURRENCY_DAILY()
