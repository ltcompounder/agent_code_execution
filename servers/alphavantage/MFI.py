...
def MFI(params: dict = None) -> dict:
    ...
    Args:
        params (dict, optional): Dictionary containing the following parameters:
            ...
            time_period (required, integer): Number of data points used to calculate each MFI value. Positive integers are accepted.
    ...
    if params is None:
        params = {}
    return call_mcp_tool("MFI", params)
