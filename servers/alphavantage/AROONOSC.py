...
def AROONOSC(params: dict = None) -> dict:
    """
    ...
    Args:
        params (dict, optional): Dictionary containing the following parameters:
            ...
            time_period (required, integer): Number of data points used to calculate each AROONOSC value. Positive integers are accepted (e.g., time_period=60, time_period=200)
    ...
    if params is None:
        params = {}
    return call_mcp_tool("AROONOSC", params)
