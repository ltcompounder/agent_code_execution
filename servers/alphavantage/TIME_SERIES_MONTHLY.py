...
def TIME_SERIES_MONTHLY(params: dict = None) -> dict:
    """
...
Returns:
    ...
    if params is None:
        params = {}
    return call_mcp_tool("TIME_SERIES_MONTHLY", params)
...
if __name__ == "__main__":
    ...
    print("Testing TIME_SERIES_MONTHLY...")
    result = TIME_SERIES_MONTHLY()
